...
final_max_min = agg_max_min %>% select(Name, wk_day_n, day_of_wk_ret, max_dow, max_day, min_dow, min_day) %>% filter(min_day==T | max_day==T)
fin_day = final_max_min %>% select(Name, wk_day_n, day_of_wk_ret, max_day, min_day)
fin_day
```
